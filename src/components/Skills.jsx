...
const skills = () => {
  return (
    <div>
      ...
      <div className="container px-20 mx-auto lg:px-24 py-16 text-center justify-around grid gap-4 lg:grid-cols-4 grid-rows-3 md:grid-cols-3 md:mx-auto sm:grid-cols-2 sm:mx-auto">
