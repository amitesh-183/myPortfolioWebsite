...
const skills = () => {
  return (
    <div>
      ...
      <div className="container lg:px-24 py-16 text-center justify-around grid gap-4 grid-cols-3 grid-rows-3 md:grid-cols-2 md:mx-auto md:px-20 sm:grid-cols-1 sm:px-14">
